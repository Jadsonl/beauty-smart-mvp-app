      ...
      <div className="space-y-6 p-4 sm:p-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8">
          <Button 
            variant="outline" 
            size="lg"
            onClick={() => window.open('mailto:jadsonunico70@hotmail.com?subject=Suporte%20-%20BelezaSmart&body=Olá,%20preciso%20de%20ajuda%20com%20o%20BelezaSmart.', '_blank')}
          ...
          <Button 
            variant="outline" 
            size="lg"
            onClick={() => window.open('https://www.youtube.com/watch?v=demo-beleza-smart', '_blank')}
            className="w-full sm:w-auto"
          >
            Ver Demonstração
          </Button>
