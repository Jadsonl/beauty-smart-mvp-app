  ...
  return (
    <Layout>
      <div className="space-y-6 sm:space-y-8 px-4 sm:px-6 lg:px-8">
        {/* Status Messages */}
        {success && (
          <div className="max-w-2xl mx-auto p-3 sm:p-4 bg-green-50 border border-green-200 rounded-lg flex items-center space-x-3">
        ...
        {canceled && (
          <div className="max-w-2xl mx-auto p-3 sm:p-4 bg-yellow-50 border border-yellow-200 rounded-lg flex items-center space-x-3">
        ...
        <div className="text-center">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Planos de Assinatura</h1>
        ...
        <Card className="max-w-4xl mx-auto">
          <CardHeader>
            ...
            <CardDescription className="text-sm sm:text-base">Formas de pagamento e política de cancelamento</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3 sm:space-y-4">
            <div>
              <h4 className="font-semibold mb-2 text-sm sm:text-base">💳 Formas de Pagamento</h4>
            ...
            <div>
              <h4 className="font-semibold mb-2 text-sm sm:text-base">🔄 Alteração de Planos</h4>
              <p className="text-xs sm:text-sm text-gray-600">
            ...
            <div>
              <h4 className="font-semibold mb-2 text-sm sm:text-base">❌ Cancelamento</h4>
              <p className="text-xs sm:text-sm text-gray-600">
